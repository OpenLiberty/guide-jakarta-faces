...
ifndef::cloud-hosted[]
Check out the web application at the http://localhost:9080/index.xhtml URL.
endif::[]
...
ifndef::cloud-hosted[]
Navigate to the http://localhost:9080/index.xhtml URL to view your web application.
endif::[]
